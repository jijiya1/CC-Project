...
public class Discussion_ReplyController {
	...
	@RequestMapping(value="/list/{nowDiscussion_b_bno}", method = RequestMethod.GET)
	public List<Discussion_ReplyVo> getDiscussionReplyList(@PathVariable("nowDiscussion_b_bno") int nowDiscussion_b_bno) throws Exception {
		
//		System.out.println("getDiscussionReplyList 실행");
		List<Discussion_ReplyVo> discussionReplyList = discussion_ReplyService.getDiscussionReply();
