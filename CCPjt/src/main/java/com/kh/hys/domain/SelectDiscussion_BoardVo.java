...
public class SelectDiscussion_BoardVo {
	...
	private String b_strCreatedDate; 	// 토론주제선정 작성일
	...
	public String getB_strCreatedDate() {
		return b_strCreatedDate;
	}


	public void setB_strCreatedDate(String b_strCreatedDate) {
		this.b_strCreatedDate = b_strCreatedDate;
	}
	...
	public String toString() {
		return "SelectDiscussion_BoardVo [b_serialno=" + b_serialno + ", b_no=" + b_no + ", b_addInfo=" + b_addInfo
				...
				+ ", b_readCount=" + b_readCount + ", b_createdDate=" + b_createdDate + ", b_strCreatedDate="
				+ b_strCreatedDate + ", b_modifiedDate=" + b_modifiedDate + ", b_recommendCount=" + b_recommendCount
