...
public class ReplyVo_Discussion {
	...
	int r_no; 					// 토론 리플번호
	String r_writer; 			// 토론 리플 작성자 닉네임
	String u_id; 				// 토론 리플 작성자 아이디
	...
	public String toString() {
		return "ReplyVo_Discussion [b_serialno=" + b_serialno + ", r_no=" + r_no + ", r_writer=" + r_writer + ", u_id="
				+ u_id + ", r_content=" + r_content + ", r_createdDate=" + r_createdDate + ", r_modifiedDate="
				+ r_modifiedDate + ", r_yesOrNo=" + r_yesOrNo + ", r_upcount=" + r_upcount + ", r_downcount="
				+ r_downcount + ", r_coment_no=" + r_coment_no + ", r_level=" + r_level + ", r_checkedDel="
				+ r_checkedDel + ", totalreplycount=" + totalreplycount + ", r_coment_count=" + r_coment_count + "]";
	}
